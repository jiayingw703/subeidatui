...
def plot():
	train_accuracy_list_d,valid_accuracy_list_d,test_accuracy_list_d= loss_drop_out()
	tf.reset_default_graph() 
	train_accuracy_list,valid_accuracy_list,test_accuracy_list= loss()
	...
	plt.plot(test_accuracy_list_d)
	plt.legend(['No dropout', 'With dropout'], loc='upper right')
	#plt.legend(['training accuracy'], loc='upper right')
	plt.title("1.3.1 Classification error with and without dropout")
