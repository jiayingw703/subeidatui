...
def train_loss(learning_rate):
	...
	for i in range(714): # 20000 iterations / 7 batches = 2857 epoch
        ...
        validation_loss_per_epoch = sess.run(loss, feed_dict={data: validData, target: validTarget})
...
def plot():
	...
	plt.title("2.1.1 Cross Entropy Loss (with learning rate: 0.01)")
