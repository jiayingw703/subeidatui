...
def plot():
    ...
    plt.plot(dicts[str(0.001)])
        ...
        #plt.plot(dicts[str(0.01)])
        #plt.plot(dicts[str(0.05)])
        #plt.plot(dicts[str(0.1)])
        #plt.plot(dicts[str(0.5)])
   
    plt.legend(['0.0001','0.0005','0.001'],loc='upper right'）
               #plt.legend(['0.001','0.005','0.01'，‘0.05’，‘0.1’，‘0.5’],loc='upper right'）
