...
def plot():
	training_loss, valid_loss, train_accy_list, valid_accy_list =lin_Reg(0.001)

	plt.figure()
	plt.plot(training_loss)
	plt.plot(valid_loss)
	plt.legend(['training loss', 'validation loss'], loc='upper right')
	plt.title("2.1.3 Linear Regression MSE for learning rate 0.001")
	plt.xlabel("Epoch")
	...
	plt.title("2.1.3 Linear Regression Accuracy for learning rate 0.001")
	plt.xlabel("Epoch")
	plt.ylabel("Accuracy")
	plt.grid(True)
	plt.show()
